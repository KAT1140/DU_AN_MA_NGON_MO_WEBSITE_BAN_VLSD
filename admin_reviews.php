...
<body class="bg-gray-50">
    <!-- Header -->
    <header class="bg-gradient-to-r from-green-600 to-teal-600 text-white shadow-xl">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-green-100 text-sm">Duyệt và kiểm duyệt đánh giá sản phẩm</p>
                    </div>
                </div>
            </div>
            <nav class="flex items-center gap-4">
                <a href="admin.php" class="text-white hover:text-green-200 transition">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
                <a href="admin_products.php" class="text-white hover:text-green-200 transition">
                    <i class="fas fa-box"></i> Sản phẩm
                </a>
                <a href="admin_orders.php" class="text-white hover:text-green-200 transition">
