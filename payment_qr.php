...
if ($payment_method === 'banking') {
    ...
    // MoMo QR - Format: 2|99|SĐT|TÊN|GHI_CHÚ|0|0|SỐ_TIỀN
    $momo_phone = $bank_info['momo']['phone'];
    $momo_content = "2|99|{$momo_phone}|{$bank_info['momo']['name']}|{$order_code}|0|0|{$total}";
    // Sử dụng Google Charts API để tạo QR code
    $qr_url = "https://chart.googleapis.com/chart?chs=400x400&cht=qr&chl=" . urlencode($momo_content) . "&choe=UTF-8";
}
?>
<!DOCTYPE html>
<html lang="vi">
